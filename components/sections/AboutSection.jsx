            ...
            >
              ...
              <div className="bg-accent/10 p-5 rounded-lg space-y-4">
                <p className="text-white/80 text-sm leading-relaxed">
                  First-year student at UW Bothell majoring in CSSE: Information Assurance and Cybersecurity.
                </p>
            ...
            >
              ...
              <div className="space-y-3">
                <div className="bg-accent/10 p-4 rounded-lg">
                  ...
                  <p className="text-white/70 text-sm">CSSE: Information Assurance and Cybersecurity</p>
